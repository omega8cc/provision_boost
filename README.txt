...
cd drupal-6.14 ; drush provision verify --boost=1 --platform_id=12345
...
Site example
~~~~~~~~~~~~
cd drupal-6.14 ; drush provision verify --boost=1

The argument to --boost determines which boost rewrite rules will be
included in the Apache configuration. If you are running a multisite
